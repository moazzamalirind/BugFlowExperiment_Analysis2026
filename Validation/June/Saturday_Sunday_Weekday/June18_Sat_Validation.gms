$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. ( Saturday-Sunday-Weekday model Validation  June 2018)
...
Num_Days(d)                          Number of days for each day type/Sunday 4, Saturday 5, Weekday 21/
;
...
Table Observed_Rel(d,p)"Releases (cfs) observed during June 2018"
                pLow      pHigh
Sunday        11120.07   10098.4
Saturday      11120.07   10082.94
Weekday       11363.14   15738.38 ;
...
Execute_Unload "Valid_SatModel_June.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_SatModel_June.gdx"
