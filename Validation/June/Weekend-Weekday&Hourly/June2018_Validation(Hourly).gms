...
initstorage                  Initial reservoir storage on 1st June 2018 (acre-ft)/12948951/
...
observed_release(d,p)        observed release during June 2018 averaged over hourly timestep (cfs)
...
*===================================================
$CALL GDXXRW.EXE input=Input_June2018.xlsx  output= Valid_June2018(Hourly).gdx  par=observed_release rng=Observed_Release(Hr)!A1:Y32 par=EnergyRate rng=Rates!A1 Rdim=1  set=d rng=day!A1 Rdim=1  par=Inflow rng=inflow!A1 Rdim=1 par=evap rng=evap!A1 Rdim=1

*Write the input Data into a GDX file
$GDXIN Valid_June2018(Hourly).gdx
...
Execute_Unload "Valid_June2018(Hourly).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_June2018(Hourly).gdx"
