...
**Steady release is for weekends. plow across week= steady release (model assumption).
...
Execute_Unload "Valid_June2018(2Periods).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_June2018(2Periods).gdx"
