...
EQ7c_AlternativeDays_Relrange$(Num_days("Unsteady","Weekday") gt 0)..         Release("Unsteady","Sunday","pHigh")- Release("Unsteady","Weekday","pLow")=l=Daily_RelRange;
...
Execute_Unload "2024_Contract_April.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls 2024_Contract_April.gdx"
