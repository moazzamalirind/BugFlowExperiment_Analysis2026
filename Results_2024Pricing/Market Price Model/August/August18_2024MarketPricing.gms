...
Further Updated May 25, 2026
By Moazzam to:
1. Added new energy pricing 2024
2. Run for 2 and 3 daytypes with new pricing.
######################################
$offtext
...
* Number of steady days   0       1        2       4      6        8      9       10     12       15      20        25      31
...
* Define the base (contract) energy pricing here. 2014_Pricing
*$ontext
...
* Define the base (contract) energy pricing here. 2024_Pricing
$ontext
Table Energy_PriceBase(d,Price,p) "Price of MegaWatt hour during different days and within period p where market price equals contract price ($ per MWh)"
                      pLow        pHigh
Sunday.Contract       56.8        81.9
Sunday.Market         56.8        81.9
Saturday.Contract     56.8        81.9
Saturday.Market       56.8        81.9
Weekday.Contract      71.6        104.8
Weekday.Market        71.6        104.8;
$offtext  +
...
* Dump all input data and results to a GAMS gdx file
Execute_Unload "Market_August_2014.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Market_August_2014.gdx"
