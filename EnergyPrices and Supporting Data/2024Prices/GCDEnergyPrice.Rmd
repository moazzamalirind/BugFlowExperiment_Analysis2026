...
# Figure 4. Time series of prices for all traces for the first two weeks of August 2024.
...
# Figure 4B. Time series of Generation for all traces for the first two weeks of August 2024.

```{r GCDpricesFig4B, echo=FALSE, warning=FALSE, message=FALSE}
...
# Table of Weekday and Weekend Off-peak and On-peak Prices


```{r GCDpricesTable1, echo=FALSE, warning=FALSE, message=FALSE}
